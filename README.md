...
| Functions        | 83.6%       |
| Lines            | 69.4%       |
| Testes unitários | 97 cenários |

**Arquivos de teste:**

- `src/energy/energy.service.spec.ts` — 11 cenários
- `src/energy/energy.repository.spec.ts` — 14 cenários
- `src/eia/eia-http.client.spec.ts` — 35 cenários
- `src/energy/sync/sync.controller.spec.ts` — 4 cenários
- `src/energy/sync/sync.scheduler.spec.ts` — 20 cenários
- `src/reports/reports.service.spec.ts` — 9 cenários
- `src/reports/reports.controller.spec.ts` — 8 cenários
- `src/app.controller.spec.ts` — 1 cenário
...
│   ├── energy.module.ts       # Módulo de energia
...
│       ├── sync.module.ts     # Módulo de sincronização
